...
> **🔄 UNDER FULL REDESIGN (2026-09-02) — nothing below is the active prescription:** Shane will collect a fresh fasted starting weight, body measurements and baseline photos, then rebuild the protocol from the actual September baseline. **Do not inherit the July dosing, phases, targets or schedule by default.** Until the redesign is completed, reta has no locked day 1 or dose. Fixed background: hCG stopped; testosterone 0.09 ml/day; China travel 17–23 Sep; new CPAP mask + nightly CPAP is the top parallel health action. `TRT-Health/current-plan.md` is the live authority.
>
...
## Healthspan Markers (Annual/Biannual)

| Marker | Target |
|---|---|
| ApoB | <80 mg/dL, ideally <60 |
| hsCRP | <1.0 |
| HbA1c | <5.4 |
| BP (home cuff) | <120/75 sustained |
| HCT/Hgb | Monitored quarterly on TRT, donate as needed |
| Resting HR | Trend; downward over time |
| HRV | Trend; upward over time |
| VO2max | Estimated via watch or formal test |
| DEXA | Every 1–2 years (composition + bone density) |
| Grip strength | Trend through 40s/50s |
...
Composition is held through:
1. Sustained training engagement (4+ hrs/wk: any mix of running + lifting)
2. Protein discipline (~150 g/day)
3. Eat to satiety with protein-first defaults
4. Sleep + alcohol control
5. Quarterly check-in (weight, photos, lift PRs, 10k time)

**Reta is reserved as an emergency reset only** — used only after genuine breakdowns (medical leave, multi-month travel block). Normal drift gets addressed with habit tightening + training re-engagement, not pharmacology.

The identity frame: "I train and eat well and my body holds" — not "I run drug cycles to maintain composition."
