...
- Immediate sequence: post the Stripe-clearing chain from the preserved Stripe exports and classify the $2,000 transfer to `9316` as owner drawings unless it matches an otherwise unexplained deposit returning money to the business accounts. Then resolve the remaining unmatched credits and classify the other evidence-led supplier debits, owner movements and ambiguous withdrawals. Receipt-supported business expenses paid personally will be entered later as owner-funded expenses, after invoices and income are complete.
