...
- Xero reconstruction is in progress. Of 253 imported account `1913` statement lines, 168 are reconciled and 85 remain (66.4% complete). The latest bounded run added the remaining 25 FY2025–26 Transport for NSW debits totalling $557.62 as `Spend money` to existing account `493 - Travel - National`, contact `Transport for NSW`, description `Business travel - Transport NSW`, and `BAS Excluded`. This completes the source-worklist projection of FY2025–26 Transport for NSW debits; the 13 projected later-period Transport rows were not posted. Exact date/amount read-back, queue and balance controls are in `workpapers/2026-09-07-xero-transport-expense-batch-2.json`.
...
- Immediate sequence: close FY2025–26 before later activity. After the 7 September merchant and Transport batches, the audit-backed projection is 48 unreconciled lines dated through 30 June 2026, followed by 37 lines dated 1 July–17 August 2026. Resolve FY credits, classify FY withdrawals, close off-ledger Stripe/personal-paid items, prove Xero to the $25,086.17 source bank balance at 30 June, then produce the tax working pack. Critical path: `workpapers/2026-09-03-fy2025-26-tax-close-critical-path.md`.
