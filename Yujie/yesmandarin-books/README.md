...
- Xero reconstruction is in progress. Of 253 imported account `1913` statement lines, 168 are reconciled and 85 remain (66.4% complete). The two 7 September Transport batches added 50 FY2025–26 Transport for NSW debits totalling $742.85 as `Spend money` to existing account `493 - Travel - National`, contact `Transport for NSW`, description `Business travel - Transport NSW`, and `BAS Excluded`. A full source-row recomputation found that the source population is 52 lines totalling $862.85, not 50: the 8 May and 19 May 2026 debits of $60.00 each remain unaudited and must be treated as unreconciled until exact Xero read-back proves otherwise. The prior batch-2 completion assertion is corrected by `workpapers/2026-09-07-xero-merchant-expense-batch-3-blocked.json`; the 13 projected later-period Transport rows were not posted.
...
- Immediate sequence: close FY2025–26 before later activity. After the completed 7 September merchant and Transport postings, the audit-backed projection remains 48 unreconciled lines dated through 30 June 2026, followed by 37 lines dated 1 July–17 August 2026; the FY group includes the two omitted Transport rows identified above. Resolve the staged merchant expenses only after live duplicate/bill checks, then resolve FY credits, classify the other FY withdrawals, close off-ledger Stripe/personal-paid items, prove Xero to the $25,086.17 source bank balance at 30 June, and produce the tax working pack. Critical path: `workpapers/2026-09-03-fy2025-26-tax-close-critical-path.md`.
- Shane confirmed on 3 September 2026 that the Amazon purchases were YesMandarin business supplies rather than owner drawings. Five source-supported Amazon debits are now reconciled to `453 - Office Expenses`, `BAS Excluded`: the four opening debits totalling $309.55 and the 29 July $54.99 debit. The matching $309.55 transfer from Shane remains an owner contribution to `881 - Owner A Funds Introduced`, not revenue and not a reversal of the business expenses. Audit: `workpapers/2026-09-07-xero-ordinary-merchant-expense-batch.json`.
