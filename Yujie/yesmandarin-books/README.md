...
- The $650 Daniel Lie receipt could not reuse INV-0066, which the verified 25 August audit tied to the explicitly referenced 13 May bank row. Shane confirmed on 3 September 2026 that the later receipt was sales for Term 3 Mandarin tuition agreed verbally. It was reconciled directly to `200 - Sales`, `BAS Excluded`, rather than against a fabricated retrospective invoice. The other unmatched credits, unresolved debits and excluded $309.55 Shane receipt still require their own evidence or classification.
