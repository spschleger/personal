...
- Immediate sequence: resolve the separate Stripe account's isolated $660.10 payout chain and $1,197.73 opening-boundary payout without turning either payout into revenue. Then resolve the remaining unmatched credits and classify the other evidence-led supplier debits, owner movements and ambiguous withdrawals. Receipt-supported business expenses paid personally will be entered later as owner-funded expenses, after invoices and income are complete.
- The non-Xero-linked Stripe account's $687.50 charge remains unattributed. The exact $660.10 bank-payout bridge and $1,197.73 opening-boundary control are documented in `workpapers/2026-09-02-separate-stripe-treatment-gates.json`; no Xero write has been made for either chain.
