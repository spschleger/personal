...
- Immediate sequence: close FY2025–26 before later activity. The audit-backed projection is 102 unreconciled lines dated through 30 June 2026 (15 credits totalling $9,474.55 and 87 debits totalling $2,635.58), followed by 37 lines dated 1 July–17 August 2026. Resolve FY credits, classify FY withdrawals, close off-ledger Stripe/personal-paid items, prove Xero to the $25,086.17 source bank balance at 30 June, then produce the tax working pack. Critical path: `workpapers/2026-09-03-fy2025-26-tax-close-critical-path.md`.
- Shane confirmed on 3 September 2026 that the Amazon purchases, including the four opening debits totalling $309.55, were YesMandarin business supplies rather than owner drawings. The matching $309.55 transfer from Shane is an owner contribution to `881 - Owner A Funds Introduced`, not revenue and not a reversal of the business expenses. After the correction, the first $76.80 Amazon debit was reconciled to `453 - Office Expenses`, `BAS Excluded`; the queue visibly fell from 140 to 139. The other three opening Amazon debits total $232.75 and remain unreconciled.
