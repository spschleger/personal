...
- Immediate sequence: close FY2025–26 before later activity. The audit-backed projection is now 30 unreconciled lines dated through 30 June 2026, followed by 37 lines dated 1 July–17 August 2026. Resolve FY credits, classify the other FY withdrawals, close off-ledger Stripe/personal-paid items, prove Xero to the $25,086.17 source bank balance at 30 June, and produce the tax working pack. Critical path: `workpapers/2026-09-03-fy2025-26-tax-close-critical-path.md`.
- The exact 30-row FY2025–26 remainder is now preserved with source-linked account-mapping proposals in `workpapers/2026-09-08-fy2025-26-remaining-inventory-and-mapping-proposals.json`. It records 16 debits totalling $1,176.74 and 14 credits totalling $9,165.00. No row was posted in that read-only preparation pass; Taobao purchase contents and the exact live Covau utility account remain deliberately unasserted pending evidence/live-chart confirmation.
