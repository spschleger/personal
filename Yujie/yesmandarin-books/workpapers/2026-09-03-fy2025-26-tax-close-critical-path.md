# FY2025–26 tax-close critical path

**Prepared:** 3 September 2026  
**Objective:** close the year ended 30 June 2026 first, then finish the later imported period.
...
### 1. Finish FY income and non-income credits
...
Before producing tax figures:

- Attribute the separate Stripe account's **$687.50** charge and post its **$24.37** processing fee and **$3.03** invoicing fee. Keep the $1,197.73 opening-boundary payout outside current-period income unless source evidence proves otherwise.
- Identify any YesMandarin expenses paid from personal accounts and enter only receipt-supported business costs as owner-funded expenses.
- Confirm no other bank account, card, cash channel or payment processor carried FY2025–26 business activity.
- Review equipment/assets, contractor payments and any payroll obligations for items not visible in account 1913.

### 4. Prove the close and prepare the tax pack

- Make Xero's 30 June 2026 bank balance agree to **$25,086.17**.
- Review every open invoice at 30 June against reconciled receipts; do not rely on stale Xero payment status.
- Produce FY2025–26 Profit & Loss, Balance Sheet, bank reconciliation report, sales/turnover control, expense schedule, asset schedule and unresolved-evidence list.
- Test rolling GST turnover against the registration threshold; current ABN evidence says the entity is not registered for GST.
- Hand Felicity or her registered tax agent a source-linked working pack. Felicity makes the declaration and lodges or appoints the agent.

## After the tax-year close

Reconcile the remaining projected 37 lines dated 1 July–17 August 2026 and import later bank activity. These lines are required for fully current books but do not block the FY2025–26 tax figures.
