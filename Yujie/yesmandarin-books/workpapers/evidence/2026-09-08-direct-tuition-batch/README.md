# Direct tuition batch recovery evidence — 8 September 2026

This folder preserves visible-Chrome evidence from the interrupted tuition posting worker and the bounded recovery run.

## Unequivocal run attribution

- **Prior interrupted worker posted:** 4 receipts, **$2,351.00** total — rows 69, 71, 125 and 126.
- **This recovery run posted:** 2 receipts, **$963.00** total — Maria John $345 and Jenny Bisset $618.
- The prior worker's transcript records each completion click before later source searches/detail views. The control moved exactly from 58 pending / $22,296.57 book balance to 54 pending / $24,647.57, matching the four source rows and their $2,351.00 total.
- This recovery did not repost any of those four rows. Its final visible control is 52 pending / $25,610.57 book balance.
