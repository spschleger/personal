...
Xero reconstruction is in progress. The full supplied account `1913` statement range is imported and 195 of 253 lines are reconciled, leaving 58. The recovered 17-line FY2025–26 merchant batch is exactly read back in Xero and totals $428.25 across Amazon, Kmart, Dollar Avenue, JB Hi-Fi, Google Workspace and Transport for NSW. The confirmed $309.55 Shane reimbursement is also exactly verified as `881 - Owner A Funds Introduced`, not revenue. The latest full checkpoint is statement balance $31,016.85 and book balance $22,296.57. The complete FY2025–26 Transport population is now 52 audit-backed rows totalling $862.85; 13 post-30 June 2026 Transport rows remain outside that completion claim. Other expenses, transfers and ambiguous receipts remain unresolved. Audits: `workpapers/2026-09-08-xero-merchant-expense-batch-3-recovery.json`, `workpapers/2026-09-08-xero-owner-funds-introduced.json`, `workpapers/2026-09-08-xero-remaining-approved-expense-batch.json` and `workpapers/2026-09-08-fy2025-26-credit-evidence-inventory.json`.
