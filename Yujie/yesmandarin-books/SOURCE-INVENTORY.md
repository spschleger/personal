...
Xero reconstruction is in progress. The imported account `1913` population is complete through 17 August 2026. The approved 5 August Maria John $345 lessons receipt is now separately posted and exactly verified as direct `Receive Money` to `200 - Sales`, `BAS Excluded`, after exact duplicate, Find & Match and zero-dollar INV-0078 controls. The live checkpoint is 13 unreconciled later-period lines, $30,076.99 book balance and $31,016.85 statement balance. No other row in the prior 14-row population was posted. The year-ended-30-June-2026 bank reconciliation control remains complete at $25,086.17 with zero unreconciled or out-of-balance amount; tax close remains provisional because separate Stripe controls remain pending. Audits: `workpapers/2026-09-08-xero-maria-john-august-direct-receipt.json`, `workpapers/2026-09-08-contractor-account-and-separate-stripe-review.json` and the earlier posting audits listed in `README.md`.

The original 30-row FY2025–26 remainder and evidence-backed mapping proposals are in `workpapers/2026-09-08-fy2025-26-remaining-inventory-and-mapping-proposals.json`. Eight approved debits totalling $500.48 were subsequently posted and verified. All 14 credits totalling $9,165.00 were then inspected individually. Hab's 16 June $680 receipt was the only unequivocal existing-invoice match and is verified in Xero as an INV-0074 invoice payment; the other 13 remain unposted. Their exact bank evidence, invoice/payment checks, proposed treatments and the eight remaining debit missing-fact questions are in `workpapers/2026-09-08-fy2025-26-credit-evidence-inventory.json`.
...
A redacted 8 September read-only review now maps all three identified invoice relationships without propagating raw Stripe identifiers. Local evidence proves the $687.50 less $24.37 less $3.03 equals $660.10 later chain and the $547.24 plus $648.10 plus $2.39 equals $1,197.73 opening chain. It does not preserve the actual invoice line items or service periods. No exact $687.50 Ann Panek invoice exists in the supplied Xero export; her two Xero invoices are later and different amounts, so neither may be reused merely because the customer matches. The opening receipts predate the Xero export. Visible Chrome Max invoice retrieval was blocked by inaccessible `0x0` computer-use captures; no login or connection boundary was crossed. Conditional proposed entries and the teaching-contractor chart judgement are in `workpapers/2026-09-08-separate-stripe-invoice-readonly-evidence-and-proposed-entries.json`; all reports remain provisional.
